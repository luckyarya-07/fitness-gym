...
return $items;
 ...
 function woocommerce_account_content_style() {
     ?>
     <style type="text/css">
 ...
 add_action('woocommerce_account_content', 'woocommerce_account_content_style', 2 );
...
function jg_user_nav_visibility() {
    ...
    if ( is_user_logged_in() ) {
        ...
        $output="<style> .nav-login { display: block; } </style>";
    }
...
function add_loginout_link( $items, $args ) {
    if (is_user_logged_in() && $args->theme_location == 'primary') {
        $items .= '<li class="right menu-item menu-item-type-post_type menu-item-object-page"><a href="'. wp_logout_url( get_permalink( woocommerce_get_page_id( 'myaccount' ) ) ) .'" class="nav-link">Logout</a></li>';
    }
    elseif (!is_user_logged_in() && $args->theme_location == 'primary') {
        $items .= '<li class="right menu-item menu-item-type-post_type menu-item-object-page"><a href="' . get_permalink( woocommerce_get_page_id( 'myaccount' ) ) . '" class="nav-link">Login/Register</a></li>';
    }
    return $items;
}
